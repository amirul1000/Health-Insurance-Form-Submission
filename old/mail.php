...
<title>Healthinsure360 Insurance Form</title>
...
<?php 
$ToEmail = 'trainee3@primediart.com'; 
$EmailSubject = 'Healthinsure360 Insurance Form';
...
echo "<script> alert('We will do our best to answer your questions ASAP!'); location.href='https://bootcampondemand.intelivideo.com'</script>";
?>